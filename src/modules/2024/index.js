    ...
    <>
      ...
      <Row> 
        ...
        <p style={{fontSize:"30px", margin:"10px"}}>Оценка <br/>производительности</p>
              ...
              {/* <Itog /> */}
              <img src="./2024.png" width="100%"></img>
        ...
        <Col span={16} style={{padding: '10px'}}>
          ...
          <p style={{fontSize:"30px"}}>iOS <small>крэши 11,7 % от всех устройств</small></p><img src="./ios24.png" width="100%"></img>
          <p style={{fontSize:"30px"}}>Android <small>крэши 4,28 % от всех устройств</small></p><img src="./android24.png" width="100%"></img>
        </Col>
      </Row> 
    </>
    );
