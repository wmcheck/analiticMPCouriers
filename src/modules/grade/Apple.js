  ...
  <>
    <div style={{display: 'flex', gap: '150px', paddingBottom: '30px'}}>
      ...
      <div>
        ...
        <div><h2 style={{margin: '0'}}>315 </h2><small>+1</small></div>
      </div>
    </div>  
